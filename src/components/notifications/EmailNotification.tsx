...
function EmailNotification({emailNoti}:emailProps) {
  return (
    <div className={`${!emailNoti&&'hidden'} absolute w-64 overflow-hidden top-14 -left-[200px] shadow-2xl rounded-md bg-white dark:bg-dark divide-y divide-gray-200 dark:divide-gray-600 z-20`}>
